...
There are 2 functions for this purpose, one is `read_induction`, it is
...
It is helpful to view all the data through a plot, you can view an OJIP
...
It is more clear to use the ‘real groups’ between data files to view
differences between treatments/replications.
...
We can also use the same method to group the imported data from the
excel files:
